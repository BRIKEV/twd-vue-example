...
// Auto-generated scale test #34. Duplicates the Todo List scenarios to grow the
// suite and stress the service-worker mock path across Chromium/Firefox/WebKit.
describe("Todo List Page [scale 34]", () => {
  beforeEach(() => {
    twd.clearRequestMockRules();
  });

  it("should display the todo list [scale 34]", async () => {
  ...
  it("should create a todo [scale 34]", async () => {
  ...
  it("should delete a todo [scale 34]", async () => {
