...
// Auto-generated scale test #13. Duplicates the Todo List scenarios to grow the
// suite and stress the service-worker mock path across Chromium/Firefox/WebKit.
describe("Todo List Page [scale 13]", () => {
  beforeEach(() => {
    twd.clearRequestMockRules();
  });

  it("should display the todo list [scale 13]", async () => {
  ...
  it("should create a todo [scale 13]", async () => {
  ...
  it("should delete a todo [scale 13]", async () => {
