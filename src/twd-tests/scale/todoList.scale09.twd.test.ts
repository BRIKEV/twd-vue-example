...
// Auto-generated scale test #09. Duplicates the Todo List scenarios to grow the
// suite and stress the service-worker mock path across Chromium/Firefox/WebKit.
describe("Todo List Page [scale 09]", () => {
  beforeEach(() => {
    twd.clearRequestMockRules();
  });

  it("should display the todo list [scale 09]", async () => {
  ...
  it("should create a todo [scale 09]", async () => {
  ...
  it("should delete a todo [scale 09]", async () => {
